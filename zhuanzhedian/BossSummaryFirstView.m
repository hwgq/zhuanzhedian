...
@interface BossSummaryFirstView ()<UITextViewDelegate>

@property (nonatomic, strong)UILabel *backLabel;
@property (nonatomic, strong)UILabel *numLabel;

@end
@implementation BossSummaryFirstView
...
- (void)createTextView
{
    ...
    self.backLabel.text = [NSString stringWithFormat:@"简单介绍一下你的公司、团队,有利于吸引人才."];
